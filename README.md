...
local Section = Tab:NewSection("Spin Blox")
Section:NewButton("Execute", "ButtonInfo", function()
...
local Section = Tab:NewSection("Monkey")
Section:NewButton("Execute", "ButtonInfo", function()
    --[[
...
local Section = Tab:NewSection("Anit Kick")
Section:NewButton("Execute", "ButtonInfo", function()
...
local Tab = Window:NewTab("Driving Simulator")
local Section = Tab:NewSection("Mairu Hub ON")
Section:NewButton("Execute", "ButtonInfo", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/GFf5MZ7R", true))()
end)
local Section = Tab:NewSection("Mairu Hub OFF")
Section:NewButton("Execute", "ButtonInfo", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/GFf5MZ7R", false))()
end)
